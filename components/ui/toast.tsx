  ...
  return (
    <ToastPrimitive.Root
      ...
      className={cn(
        ...
        variant === "default" && "border-[#E5E9F2] bg-white text-navy-ink",
        variant === "success" && "border-success/20 bg-success/10 text-navy-ink",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitive.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-text-muted opacity-0 transition-opacity hover:text-navy-ink focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100",
      className
    )}
    toast-close=""
    {...props}
