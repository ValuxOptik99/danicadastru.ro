...
const majorCities: MajorCity[] = [
  ...
  { name: "Năvodari",  x: 275.0, y: 318.0, anchor: "right" },
...
const secondaryCities: SecondaryCity[] = [
  { name: "Eforie",          x: 282.0, y: 400.0 },
  { name: "Techirghiol",     x: 270.0, y: 416.0 },
  { name: "Costinești",      x: 280.0, y: 434.0 },
  { name: "Vama Veche",      x: 267.3, y: 483.4 },
  { name: "Ovidiu",          x: 262.0, y: 348.0 },
  { name: "Murfatlar",       x: 236.0, y: 372.0 },
  { name: "Valu lui Traian", x: 250.0, y: 390.0 },
