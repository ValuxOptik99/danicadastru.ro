...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages = [
    ...
    { url: `${BASE_URL}/servicii/certificat-edificare`, changeFrequency: "monthly" as const, priority: 0.8 },
    { url: `${BASE_URL}/servicii/certificat-energetic`, changeFrequency: "monthly" as const, priority: 0.8 },
    { url: `${BASE_URL}/servicii/certificat-urbanism`, changeFrequency: "monthly" as const, priority: 0.8 },
