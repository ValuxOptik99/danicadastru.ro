      ...
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="grid grid-cols-2 gap-3 sm:flex sm:w-auto">
          <Link
            ...
            className="inline-flex items-center justify-center gap-1.5 rounded-full bg-brand-cyan px-4 py-2.5 text-xs font-semibold text-navy-950 transition hover:brightness-110 sm:py-2"
          >
          ...
          <Link
            href="/admin/cereri"
            className="inline-flex items-center justify-center gap-1.5 rounded-full border border-[#E5E9F2] bg-white px-4 py-2.5 text-xs font-semibold text-navy-ink transition hover:bg-bg-muted sm:py-2"
          >
